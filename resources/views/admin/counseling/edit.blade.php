            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <form method="POST" action="{{ route('counseling.update', $counseling->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="student_id" required>
                                    @foreach ($students as $student)
                                        <option value="{{ $student->id }}"
                                            {{ $student->id == $counseling->student_id ? 'selected' : '' }}>
                                            {{ $student->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="session_date" name="session_date"
                                    value="{{ old('session_date', $counseling->session_date) }}" required>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        <option value="individual"
                                            {{ $counseling->type == 'individual' ? 'selected' : '' }}>Individual
                                        </option>
                                        <option value="kelompok"
                                            {{ $counseling->type == 'kelompok' ? 'selected' : '' }}>Kelompok
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="problem_area" name="problem_area" required>
                                        <option value="pribadi"
                                            {{ $counseling->problem_area == 'pribadi' ? 'selected' : '' }}>Pribadi
                                        </option>
                                        <option value="belajar"
                                            {{ $counseling->problem_area == 'belajar' ? 'selected' : '' }}>Belajar
                                        </option>
                                        <option value="sosial"
                                            {{ $counseling->problem_area == 'sosial' ? 'selected' : '' }}>Sosial
                                        </option>
                                        <option value="karir"
                                            {{ $counseling->problem_area == 'karir' ? 'selected' : '' }}>Karir
                                        </option>
                                    </select>
                                </div>
                            </div>
